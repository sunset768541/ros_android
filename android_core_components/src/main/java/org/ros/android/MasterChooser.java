...
public class MasterChooser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CheckBox onlyUseImu = findViewById(R.id.only_imu_checkBox);
        onlyUseImu.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                Config.isOnlyUseImu = isChecked;
                Log.e("MasterChooser", "isOnlyUseImu:" + isChecked);
            }
        });
        ...
        String uri = "http://192.168.2.1:11311/";
